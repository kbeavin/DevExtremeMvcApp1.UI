...
namespace DevExtremeMvcApp1_UI.Data
{
    ...
    public partial class completion_invoicedetail
    {
        ...
        public Nullable<int> ivd_completion_odometer { get; set; }
        public string ivd_completion_billable_flag { get; set; }
        public string ivd_completion_payable_flag { get; set; }
        public string ivd_completion_drv_id { get; set; }
        public string ivd_completion_drv_name { get; set; }
